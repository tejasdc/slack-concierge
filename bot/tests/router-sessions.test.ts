...
const commands = sourceVariants.flatMap(({ source, sourceFlags }) => [
  ...
  { args: ["ask", "--provider", "chatgpt", ...sourceFlags, "--action-id", "chatgpt-1", "--", text],
    operation: "ask", body: { source, action_id: "chatgpt-1", provider: "chatgpt", text } },
...
const invalidCommands = [
  ...
  ["ask", address, ...sourceFlags, "--provider", "chatgpt", "--action-id", "a", "--", "text"],
  ["ask", "--provider", "codex", ...sourceFlags, "--action-id", "a", "--", "text"],
  ["ask", "--provider", "chatgpt", "--action-id", "a", "--", "text"],
  ["ask", ...nativeSourceFlags, "--action-id", "a", "--", "text"],
