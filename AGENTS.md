...
- Treat `notes/TODOS.md` as the canonical todo document. Slack Lists is a bidirectional projection with stable row IDs and explicit conflict handling, never prompt context or an agent-output control protocol.
