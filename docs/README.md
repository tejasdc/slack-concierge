...
- [Historical sessions as consultants](plans/2026-09-14-historical-session-consultation.md) — design-only research on native resume/fork, reconstructed history, archive portability, OpenClaw adoption, Pi, fidelity metadata, and import acceptance for the Thinkering-first session service.
