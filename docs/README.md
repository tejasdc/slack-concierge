...
- [Codex usage limit is account-scoped (2026-09-15)](incidents/2026-09-15-codex-usage-limit-scope.md) — probe evidence that no Codex-to-Codex fallback can fire, the inventory of undelivered turns, why replay cannot recover most of them, and the options that remain open.
