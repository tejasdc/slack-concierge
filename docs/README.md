...
- [Compact Agent progress](plans/2026-08-26-compact-agent-progress.md) — latest commentary, collapsed history, turn-wide native elapsed time, active Thinking, and Steps in one message.
