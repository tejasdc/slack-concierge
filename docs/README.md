...
- [Wait for existing work](plans/2026-09-10-wait-for-existing-work.md) — design only: one request API, service-owned posting as the user, serialized admission, fixed execution dependencies across channels, and emoji-only waiting/restart behavior.
