...
- [Older MacBook session consultation handoff](plans/2026-09-15-mac-session-consultation-handoff.md) — completed experiments and preserved native checkpoint; single Concierge owner under the joint proposal, hard consultation-only discovery/runtime policy, and remaining C1/X1 product acceptance after approval.
