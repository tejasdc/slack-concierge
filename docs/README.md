...
- [Wait for existing work](plans/2026-09-10-wait-for-existing-work.md) — design only: fixed execution dependencies across channels, user-authored requests through shared admission, emoji-only waiting, and durable binding/restart behavior.
